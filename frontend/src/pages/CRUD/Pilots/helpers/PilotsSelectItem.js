...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/pilots/autocomplete`, { params });
  return response.data;
}

const PilotsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.pilots.hasPermissionToCreate,
});

export default connect(select)(PilotsSelectItem);
