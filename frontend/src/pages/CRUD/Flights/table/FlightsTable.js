...
// eslint-disable-next-line
import * as aircraftsDataFormat from 'pages/CRUD/Aircrafts/table/AircraftsDataFormatters';
...
const FlightsTable = () => {
  ...
  const columns = [
...

    {
      ...
      sortable: false,
      renderCell: (params) =>
        aircraftsDataFormat.listFormatter(
  ...
  return (
    <div>
      <Widget title={<h4>{humanize('Flights')}</h4>} disableWidgetMenu>
        ...
        >
          <DataGrid
            ...
            loading={loading}
            onRowClick={(e) => {
              history.push(`/admin/flights/${e.id}/edit`);
            }}
            autoHeight
          />
        </div>
          ...
          <LinkMaterial
            ...
            href={
              process.env.NODE_ENV === 'production'
                ? window.location.origin + '/api-docs/#/Flights'
                : 'http://localhost:8080/api-docs/#/Flights'
            }
          >
