...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/aircrafts/autocomplete`, { params });
  return response.data;
}

const AircraftsSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.aircrafts.hasPermissionToCreate,
});

export default connect(select)(AircraftsSelectItem);
