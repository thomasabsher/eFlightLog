...
import AircraftsFormPage from 'pages/CRUD/Aircrafts/form/AircraftsFormPage';
import AircraftsTablePage from 'pages/CRUD/Aircrafts/table/AircraftsTablePage';
...
import PilotsFormPage from 'pages/CRUD/Pilots/form/PilotsFormPage';
import PilotsTablePage from 'pages/CRUD/Pilots/table/PilotsTablePage';
      ...
      >
        ...
        <Switch>
          ...
          <Route
            ...
            exact
            component={AircraftsTablePage}
          />
          <Route
            path={'/admin/aircrafts/new'}
            exact
            component={AircraftsFormPage}
          />
          <Route
            path={'/admin/aircrafts/:id/edit'}
            exact
            component={AircraftsFormPage}
          />
          ...
          <Route path={'/admin/pilots'} exact component={PilotsTablePage} />
          <Route path={'/admin/pilots/new'} exact component={PilotsFormPage} />
          <Route
            path={'/admin/pilots/:id/edit'}
            exact
            component={PilotsFormPage}
          />
        </Switch>
        <Fab
          color='primary'
