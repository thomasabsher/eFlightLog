...
class PilotsRepository extends BaseRepository implements PilotsRepositoryInterface
{
    public function __construct(Pilots $model)
    {
    ...
    public function findAll($params) : array
    {
        ...
        if (isset($params['filter'])) {
            ...
            if (isset($filter['license'])) {
                $query->where('license', 'like', '%'.$filter['license'].'%');
            }
